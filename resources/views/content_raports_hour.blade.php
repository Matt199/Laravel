	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="portlet box red-intense">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Raport Godzinowy
							</div>
							<div class="actions">
								<div class="btn-group">
									...
									<div id="sample_4_column_toggler" class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">
										<label><input type="checkbox" checked data-column="0">Godzina</label>
										<label><input type="checkbox" checked data-column="1">EPC</label>
